      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8">
        <div className="bg-[#020621] p-6 rounded-lg shadow-md text-center">
          <div className="w-12 h-12 bg-white rounded-full mx-auto mb-4 flex justify-center items-center">
            <i className="bi bi-briefcase-fill text-[#020621] text-2xl"></i>
          </div>
        ...
        <div className="bg-[#020621] p-6 rounded-lg shadow-md text-center">
          <div className="w-12 h-12 bg-white rounded-full mx-auto mb-4 flex justify-center items-center">
            <i className="bi bi-file-earmark-text text-[#020621] text-2xl"></i>
          </div>
          <h3 className="text-lg font-bold mb-2" style={{ color: '#D98900' }}>
            Análise Documental
          </h3>
        ...
        <div className="bg-[#020621] p-6 rounded-lg shadow-md text-center">
          <div className="w-12 h-12 bg-white rounded-full mx-auto mb-4 flex justify-center items-center">
            <i className="bi bi-folder2-open text-[#020621] text-2xl"></i>
          </div>
          <h3 className="text-lg font-bold mb-2" style={{ color: '#D98900' }}>
        ...
        <div className="bg-[#020621] p-6 rounded-lg shadow-md text-center">
          <div className="w-12 h-12 bg-white rounded-full mx-auto mb-4 flex justify-center items-center">
            <i className="bi bi-box-arrow-in-right text-[#020621] text-2xl"></i>
          </div>
          <h3 className="text-lg font-bold mb-2" style={{ color: '#D98900' }}>
            Entrada com a Ação
          </h3>
